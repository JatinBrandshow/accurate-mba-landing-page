    ...
    const faqs = useMemo(
        () => [
            ...
            },
            {
                ...
                answer: "Candidates must have passed intermediate (10+2) examination from recognized board with minimum 50% marks. Students from any stream are eligible to apply.",
            },
            {
                category: "Admissions",
                question: "Is there an entrance exam for BCA?",
                answer: "No entrance exam required. Admission is merit-based on 10+2 marks. Students can apply online or visit the college for guidance and support.",
            },
            {
                category: "Fees",
                popular: true,
                question: "What is the fee structure for the BCA program?",
                answer: "Total course fee is ₹2,90,000 for 3 years. 1st year: ₹1,00,000, 2nd year: ₹95,000, 3rd year: ₹95,000. Flexible payment options available.",
            },
            {
                category: "Curriculum",
                question: "What subjects are covered in the BCA course?",
                answer: "The curriculum includes Mathematics, Programming Principles & Algorithm (PPA), Computer Fundamentals & Office Automation (CFOA), and various programming languages.",
            },
            {
                category: "Placements",
                popular: true,
                question: "What is the placement record for BCA students?",
                answer: "We have 100% placement record with average package of ₹4 LPA. Students are placed in leading IT companies as Software Developers, Web Developers, and System Analysts.",
            },
            {
                category: "Placements",
                question: "Which companies recruit BCA graduates?",
                answer: "Leading IT companies like TCS, Wipro, Infosys, HCL, Tech Mahindra, and many startups actively recruit our BCA graduates for various technical roles.",
            },
            {
                category: "Curriculum",
                question: "Does the BCA program include practical training?",
                answer: "Yes, the program emphasizes instructor-led learning with practical technology applications, computer labs, live projects, and industry-oriented workshops.",
            },
            {
                category: "Campus",
                question: "What facilities are available at the campus?",
                answer: "Modern computer labs, libraries, classrooms with latest technology infrastructure, Wi-Fi connectivity, and all necessary amenities for quality education.",
            },
            {
                category: "Curriculum",
                question: "Can I pursue higher studies after BCA?",
                answer: "Yes, after BCA you can pursue MCA, MBA, M.Sc. IT, or specialized certifications. The program builds a strong foundation for advanced computer studies.",
            },
            {
                category: "Admissions",
                question: "What is the affiliation of the BCA program?",
                answer: "The BCA program is affiliated with CCS University, Meerut, ensuring industry recognition and quality education standards.",
            },
            {
                category: "Fees",
                question: "Are there any scholarship opportunities?",
                answer: "Yes, scholarships and education loan assistance are available for eligible students. Merit-based scholarships are also provided to deserving candidates.",
            },
        ],
        []
    );
    ...
    return (
        <section ref={ref} id="faq" className="relative overflow-hidden bg-slate-50 py-10">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-1/4 h-100 w-100 rounded-full bg-purple-100/30 blur-[100px]" />
            </div>
