...
const OurStrengths = () => {
    ...
    const reasons = [
        "AICTE approved and UGC recognized MBA degree",
        "State-of-the-art infrastructure and learning facilities",
        "Industry-oriented curriculum with case studies",
        ...
        "Active alumni network across industries",
                    ...
                    <div className="grid items-center gap-12 md:grid-cols-2">
                        ...
                        >
                            ...
                            <p className="mb-8 text-lg text-gray-600">
                                Our MBA program stands out for its commitment to excellence, innovation, and student
                                success. Here's what makes us different:
                            </p>
